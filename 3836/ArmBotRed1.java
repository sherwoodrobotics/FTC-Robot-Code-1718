...
@Autonomous(name = "ArmBotRed1", group = "ArmBot")
public class ArmBotRed1 extends MarvAutonomous {
...
private static final int MOTOR_TICKS = 1120;
    ...
    public void runAutonomous() {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (hardware.colorSensor.blue() > 1.75f * hardware.colorSensor.red()) {
                    //Blue on right
                    hardware.lightsaberYawServo.setPosition(0.80f);
                    Wait(1f);
        ...
        drive(DRIVE_SPEED, 35f);
        turn(TURN_SPEED, -135f);
        drive(DRIVE_SPEED, -22f);
        String direction = "LEFT";//vuforia.isMarkerFound().toString();
        ...
        switch (direction) {
            case "LEFT":
                //Forward 35, over 14
                angle = 45f-5f; //was 45f - 21.80f
                distance = 10f;
                break;
            case "CENTER":
                //Forward 35, over 7
                angle = 45f - 21.80f; // was 45f - 11.31f
                distance = 9f;
                break;
            case "RIGHT":
                //Forward 35, over 0
        ...
        //Push block into column, then back up
        Wait(1f);
        drive(DRIVE_SPEED, distance);
        Wait(0.5f);
        drive(DRIVE_SPEED, -5f);
