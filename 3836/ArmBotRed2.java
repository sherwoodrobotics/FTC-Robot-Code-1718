...
@Autonomous(name = "ArmBotRed2", group = "ArmBot")
public class ArmBotRed2 extends MarvAutonomous {
...
private static final int MOTOR_TICKS = 1120;
    ...
    public void runAutonomous() {
        ...
        //Let go of block
        Wait(1f);
        hardware.rightHandServo.setPosition(0.4f);
        hardware.rightHandServoB.setPosition(0.6f);
        hardware.leftHandServo.setPosition(0.6f);
        hardware.leftHandServoB.setPosition(0.4f);
        
        //Back up, raise arm, then drive back forwards
        drive(DRIVE_SPEED, -3f);
        moveElbowMotors(30f);
        drive(DRIVE_SPEED, 9f);
        drive(DRIVE_SPEED, -3f);
