...
@Autonomous(name = "RedOne", group = "Blue")
public class RedOne extends MarvAutonomous {
    ...
    public void runAutonomous() {
        ...
        switch (vuforia.isMarkerFound().toString()) {
            case "LEFT":
                leftRedOne(); // All of the code to place the block in the left column
                break;
            case "RIGHT":
                rightRedOne(); // All of the code to place the block in the right column
                break;
            case "CENTER":
                centerRedOne(); // All of the code to place the block in the center column
                break;
            default:
                centerRedOne();
                break;
    ...
    public void centerRedOne() {
        
        encoderDriveBlue(0.7, 31.0, 31.0, 15.0);
        Wait(0.5f);
        
        turn(-44f);
        Wait(0.5f);
        
        encoderDriveBlue(0.7, -2.8, -2.8, 1.0);
        ...
        encoderDriveBlue(0.28, 4.0, 4.0, 1.0);
        
        encoderDriveBlue(0.4, -6.0, -6.0, 5.0);
    }
    
     public void rightRedOne() {
        
        encoderDriveBlue(0.7, 26.0, 26.0, 10.0);
        Wait(0.5f);
    ...
    public void leftRedOne() {
        
        encoderDriveBlue(0.7, 29.0, 29.0, 15.0);
        Wait(0.5f);
        ...
        encoderDriveBlue(0.3, 6.0, 6.0, 5.0);
    ...
    public void lightsaberActivate() {
        ...
        //Deploy lightsaber
        hardware.lightsaberYawServo.setPosition(0.25f); // Yaw == left/right
        Wait(0.5f);
        ...
        if (hardware.colorSensor.blue() > 1.5f * hardware.colorSensor.red()) {
            ...
            // Red on right
            hardware.lightsaberYawServo.setPosition(-0.2f);
            Wait(1f);
