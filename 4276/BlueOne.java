...
@Autonomous(name = "BlueOne", group = "Blue")
public class BlueOne extends MarvAutonomous {
    ...
    public void runAutonomous() {
        ...
        switch (vuforia.isMarkerFound().toString()) {
            case "LEFT":
                leftBlueOne(); // All of the code to place the block in the left column
                break;
            case "RIGHT":
                rightBlueOne(); // All of the code to place the block in the right column
                break;
            case "CENTER":
                centerBlueOne(); // All of the code to place the block in the center column
                break;
            default:
                leftBlueOne();
                break;
    ...
    public void centerBlueOne() {
        
        encoderDriveBlue(0.8, -19.0, -19.0, 10.0);
        
        Wait(1.0f);
        
        turn(-45f);
        
        encoderDriveBlue(0.7, -6.5, -6.5, 3.0);
        ...
        encoderDriveBlue(0.28, 5.0, 5.0, 3.0);
        
        encoderDriveBlue(0.4, -6.0, -6.0, 3.0);
    }
    
     public void rightBlueOne() {
        
        encoderDriveBlue(0.7, -23.0, -23.0, 10.0);
        
        Wait(0.5f);
        
        turn(-45f);
        
        encoderDriveBlue(0.7, -6.3, -6.3, 3.0);
        
        turn(-45f);
        
        encoderDriveBlue(0.4, 5.0, 5.0, 5.0); 
        
        hardware.topLeftArm.setPosition(0.34f);
        hardware.topRightArm.setPosition(0.65f);
        Wait(1.5f);
        
        encoderDriveBlue(0.7, -3.0, -3.0, 5.0);
        ...
        encoderDriveBlue(0.28, 5.0, 5.0, 5.0);
        
        encoderDriveBlue(0.4, -6.0, -6.0, 5.0);
    }
    
    public void leftBlueOne() {
        ...
        encoderDriveBlue(0.4, -4.0, -4.0, 1.0);
        Wait(0.5f);
        ...
        encoderDriveBlue(0.7, -3.0, -3.0, 1.0);
        Wait(0.5f);
        ...
        encoderDriveBlue(0.28, 10.0, 10.0, 5.0);
