...
@Autonomous(name = "RedTwo", group = "Blue")
public class RedTwo extends MarvAutonomous {
    ...
    public void runAutonomous() {
        ...
        switch (vuforia.isMarkerFound().toString()) {
            case "LEFT":
                leftRedTwo(); // All of the code to place the block in the left column
                break;
            case "RIGHT":
                rightRedTwo(); // All of the code to place the block in the right column
                break;
            case "CENTER":
                centerRedTwo(); // All of the code to place the block in the center column
                break;
            default:
                centerRedTwo();
                break;
    ...
    public void centerRedTwo() {
    if (opModeIsActive()) {

        
        encoderDriveBlue(0.7, 21.0, 21.0, 10.0);
        Wait(0.5f);
        
        turn(33f);
        Wait(0.5f);
        
        encoderDriveBlue(0.5, 7.0, 7.0, 3.0);
        
        hardware.topLeftArm.setPosition(0.34f);
        hardware.topRightArm.setPosition(0.65f);
        Wait(1.5f);
        
        encoderDriveBlue(0.7, -5.0, -5.0, 5.0);
        ...
        encoderDriveBlue(0.4, 8.0, 8.0, 2.0);
        
        encoderDriveBlue(0.4, -4.0, -4.0, 3.0);
        }
    }
    
     public void rightRedTwo() {
    if (opModeIsActive()) {

        encoderDriveBlue(0.7, 22.0, 22.0, 10.0);
        Wait(0.5f);
        ...
        encoderDriveBlue(0.28, 9.0, 9.0, 3.0);
        
        encoderDriveBlue(0.4, -2.0, -2.0, 2.0);
    }
    }
    
    public void leftRedTwo() {
    if (opModeIsActive()) {
        ...
        encoderDriveBlue(0.50, 10.0, 10.0, 3.0);
